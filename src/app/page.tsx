...
// dentro del JSX:
<Image src="/super-juampy-logo.png" alt="Super Juampy" width={64} height={64} priority />
...
<h1 className="text-3xl font-extrabold tracking-tight">Super Juampy</h1>
        ...
        <div className="mt-6 grid gap-3">
          ...
          <a href="/pos" className="rounded-lg px-4 py-3 bg-green-700 text-white hover:bg-green-800 transition">
            Ir al POS
          </a>
          <a href="/inventory" className="rounded-lg px-4 py-3 bg-indigo-600 text-white hover:bg-indigo-700 transition">
            Inventario
          </a>
          <a href="/reports" className="rounded-lg px-4 py-3 bg-yellow-400 text-gray-900 hover:bg-yellow-500 transition">
            Reportes
          </a>
        </div>
      </section>
